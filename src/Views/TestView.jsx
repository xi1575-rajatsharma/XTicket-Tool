        ...
        {resetPassword === "false" ? (
          <div className="reset__popup">
            <div className="reset__popup--info">
              <span
                className="reset__popup--close"
                onClick={this.props.changeresetPasswordtoTrue}
              >
                X
              </span>
              <div className="reset__popup--icon-wrapper">
                <img
                  src={icon}
                  alt="Xenie Icon"
                  className="reset__popup--icon"
                />
              </div>
              <p className="reset__popup--info-text">
                We recommend you to change your existing password. You have
                logged in as admin and we want you to keep your account safe.
                Click Here to &rarr;{" "}
        ...
        <div className="filters-wrapper">
          <div className="filters-left-wrapper">
            <select
              ...
              onChange={(e) => {
                this.props.statusFilter(e.target.value);
                this.setState({
            ...
            >
              ...
              {allStatus ? <FilterView allStatus={allStatus} /> : null}
          ...
          <div className="filters-right-wrapper">
            ...
            {listingData ? (
              ...
              this.state.display === "SubIssue" ? null : (
                <TicketFilters
                  listingData={listingData}
                  statusFilter={this.props.statusFilter}
                  changeFilterSelectValue={this.changeFilterSelectValue}
                />
              )
            ) : null}
            ...
            <div className="xenie-buttons-wrapper">
              <a
                ...
                className={this.state.xenieButton}
                href="#"
              >
                Xenie Tickets
              </a>
              <a
                onClick={() => {
                  this.props.getZohoTicketData();
                  this.setState({
                    selectValue: "OPEN",
                    xenieButton: "history-btn btn-white",
                    zohoButton: "history-btn btn-regal-blue",
                  });
                }}
                className={this.state.zohoButton}
                href="#"
              >
                Tickets From Zoho
              </a>
            ...
            {this.props.view === "Xenie" ? (
              listingData ? (
                listingData.length === 0 ? (
                  <tr className="no-updates-row">
                    <td></td>
                    <td></td>
                    <td></td>
                    <td>--No tickets here--</td>
                    <td></td>
                    <td></td>
                    <td></td>
                  </tr>
