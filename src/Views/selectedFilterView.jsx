        ...
        <>
            {
                display === "Date" ?
                    ...
                    display === "Subject" ?
                        ...
                        : display === "Name" ? <form onSubmit={(e) => { e.preventDefault(); onInputSubmit(e.target.id) }} id="employeeName"> <input onChange={e => onInputChange({ filterString: e.currentTarget.value })} type="text" placeholder="Filter by Employee Name.." /> </form> : null
            }
