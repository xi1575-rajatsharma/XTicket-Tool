    ...
    return (
        <div className={sideBarClass}>
            ...
            <div className="sideBar-heading-wrapper"  >
                <div className="replies-heading-wrapper">Replies <img onClick={closeHandler} src={doubleLeft} alt="back-arrow" height="20px" /></div>
                {/* <button onClick={closeHandler}>Close X</button> */}
                <div><img src={closeWindow} onClick={closeHandler} width="50px" height="50px" /></div>
            </div>
